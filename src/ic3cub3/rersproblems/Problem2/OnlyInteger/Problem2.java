package ic3cub3.rersproblems.Problem2.OnlyInteger;
...
}private  void calculateOutputm39(int input) {
    if(((cf==1) && (input == 2))){
    	 cf = (0);
    	a59 = (4);
    	a83 = (7);
...
}private  void calculateOutputm40(int input) {
    if(((cf==1) && (input == 1))){
    	 cf = (0);
...
}private  void calculateOutputm41(int input) {
    if(((input == 5) && (cf==1))){
    	 cf = (0);
