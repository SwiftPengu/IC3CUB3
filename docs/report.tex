...
When the refining phase ends, this means that all counterexamples were refuted by strengthening all involved frontier sets. We know %(do we?)
...
\begin{tabularx}{\linewidth}{X|l|l|l|l|l|l}
	...
	Updated build file & 	1h &&&&&	1h	\\
	Write discussion part &	2h &&&&		2h	\\\hline
\end{tabularx}
